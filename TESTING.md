...
[W3C](https://validator.w3.org/) was used to validate the HTML on all pages of the website. It was also used to validate the CSS. I have checked the HTML via direct input and by inspecting the page source and running this through the validator.
...
| `First Time Visitors` |
|  |  |  |
| Navigation | A navigation bar giving access to the game and the probability calculator. |<img src="assets/documentation/navigationbar.jpg" alt="Navigation Bar"/>|
...
| Clear and accessible instructions | The game objective and ranking of cards as well as an ante and betting explanation is included. |<img src="assets/documentation/rankobjective.jpg" alt="Rank & Objective"/>|
...
| Reset Button | The reset button refreshes and displays the back image on dealer and player cards | Pressed reset button multiple times in testing | Ran console log on JavaScript and watched the function reset cards | Pass |
...
| 3 | The probability calculator does not calculate precisely. | This is because the function calculates the probability of the value of card3 being in between the value of card1 and card2 but does not filter out card1 and card2 when calculating. If I had more time, I would look in to this and likely implement a solution in a future iteration |
